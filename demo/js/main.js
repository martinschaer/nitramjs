require.config({
  ...
  paths: {
    ...
    'history': 'https://cdnjs.cloudflare.com/ajax/libs/history.js/1.8/bundled/html5/native.history',
    // 'handlebars': '//cdnjs.cloudflare.com/ajax/libs/handlebars.js/1.1.0/handlebars.min',
    'nitram': 'https://raw.github.com/martinschaer/nitramjs/master/dist/nitram.min',
    'app': 'https://raw.github.com/martinschaer/nitramjs/master/demo/js/app'
  },
  shim: {
    'app': {
...
require(['jquery', 'app', 'history'], function($, app) {
